...
export const SEED_OBJECTS: SeedObject[] = [
  {
    id: "seed_obj_venues_00000000000000",
    name: "venues",
    ...
    fields: [
      ...
      { name: "Price Range", type: "text" },
      {
        name: "Status",
        type: "enum",
        enumValues: ["Researching", "Contacted", "Quoted", "Booked", "Used", "Rejected"],
      },
  ...
  {
    id: "seed_obj_events_0000000000000",
    name: "events",
    ...
    fields: [
      { name: "Event Name", type: "text", required: true },
      {
        name: "Event Type",
        type: "enum",
        enumValues: ["Dinner", "Meetup", "Conference", "Workshop", "Party"],
      },
      ...
      { name: "Location", type: "text" },
      {
        name: "Venue Status",
        type: "enum",
        enumValues: ["Searching", "Shortlisted", "Confirmed", "Cancelled"],
      },
      { name: "Headcount Target", type: "text" },
      { name: "RSVP Count", type: "text" },
      { name: "Budget", type: "text" },
      {
        name: "Status",
        type: "enum",
        enumValues: ["Planning", "Invites Sent", "Confirmed", "Day-of", "Completed", "Cancelled"],
      },
      { name: "Eventbrite URL", type: "text" },
      { name: "Notes", type: "richtext" },
    ],
  },
  {
    id: "seed_obj_comms_000000000000000",
    name: "communications",
    description: "Venue outreach log — calls, emails, and their outcomes",
    icon: "phone-outgoing",
    defaultView: "table",
    entryCount: 0,
    fields: [
      { name: "Type", type: "enum", enumValues: ["Call", "Email", "SMS"], required: true },
      { name: "Direction", type: "enum", enumValues: ["Outbound", "Inbound"] },
      ...
      { name: "Summary", type: "text" },
      {
        name: "Outcome",
        type: "enum",
        enumValues: ["Pending", "Responded", "Booked", "Declined", "No Answer", "Follow-up Needed"],
      },
      { name: "Event", type: "text" },
      { name: "Date", type: "date" },
      { name: "Duration", type: "text" },
      { name: "Transcript Path", type: "text" },
      { name: "Notes", type: "richtext" },
    ],
  },
];
...
export const MANAGED_SKILLS: ReadonlyArray<{ name: string; templatePaths?: boolean }> = [
  ...
  { name: "event-orchestration", templatePaths: true },
  { name: "privacy-layer", templatePaths: true },
];
