...
function registerThemes(monaco: typeof import("monaco-editor")) {
	...
	monaco.editor.defineTheme("denchclaw-light", {
		...
		colors: {
			...
			"editor.selectionBackground": "#ff554120",
			"editor.inactiveSelectionBackground": "#ff554110",
			...
			"editor.selectionHighlightBackground": "#ff554112",
			"editorCursor.foreground": "#ff5541",
			"editorWhitespace.foreground": "#00000010",
			"editorBracketMatch.background": "#ff554115",
			"editorBracketMatch.border": "#ff554140",
	...
	monaco.editor.defineTheme("denchclaw-dark", {
		...
		colors: {
			...
			"editor.selectionBackground": "#ff554130",
			"editor.inactiveSelectionBackground": "#ff554118",
			...
			"editor.selectionHighlightBackground": "#ff554118",
			"editorCursor.foreground": "#ff5541",
			"editorWhitespace.foreground": "#ffffff08",
			"editorBracketMatch.background": "#ff554120",
			"editorBracketMatch.border": "#ff554150",
